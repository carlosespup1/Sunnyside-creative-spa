...
const Brand = () => {
    return(
        <>
            ...
            <Col xs={12} md={{span:6, order:'first'}} className="first-row-2 rows-size text-center d-flex flex-column align-items-center justify-content-center">
            ...
            <Col xs={12} md={{span: 6, order: 'second'}} className="second-row-2 rows-size text-center d-flex flex-column align-items-center justify-content-center">
